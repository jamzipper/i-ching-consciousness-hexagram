...
// ─── Hexagram lookup: HT[lower][upper] = King-Wen number ────
const HT = [ null,
...
// Build hex line objects for wx:for rendering
// lines[0]=bottom … lines[5]=top; display order top→bottom
function buildHexLines(lines, movingIdx) {
...
module.exports = { T, HT, HN, BRANCHES, getBranch, trigramFromLines, buildHexLines };
